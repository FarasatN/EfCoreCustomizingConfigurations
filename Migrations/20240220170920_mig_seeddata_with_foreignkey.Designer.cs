...
namespace EfCoreCustomizingConfigurations.Migrations
{
    ...
    [Migration("20240220170920_mig_seeddata_with_foreignkey")]
    partial class mig_seeddata_with_foreignkey
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EfCoreShadowProperties.Program+Blog", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            BlogId = 1,
                            CreatedDate = new DateTime(2024, 2, 20, 21, 9, 20, 229, DateTimeKind.Local).AddTicks(8196),
                            Title = "Quantum"
                        },
                        new
                        {
                            BlogId = 2,
                            CreatedDate = new DateTime(2024, 2, 20, 21, 9, 20, 229, DateTimeKind.Local).AddTicks(8210),
                            Title = "Evolution"
                        });
                });
            ...
            modelBuilder.Entity("EfCoreShadowProperties.Program+Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 2, 20, 21, 9, 20, 229, DateTimeKind.Local).AddTicks(8366)
                        },
                        new
                        {
                            PostId = 2,
                            ...
                            CreatedDate = new DateTime(2024, 2, 20, 21, 9, 20, 229, DateTimeKind.Local).AddTicks(8369)
                        });
                });
